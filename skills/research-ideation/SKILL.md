...
1. **Understand the input.** Read `$ARGUMENTS` and any referenced files. Check `papers/` for related papers. Check `rules/` for domain conventions.
...
5. **Save the output** to `output/research_ideation_[sanitized_topic].md`
